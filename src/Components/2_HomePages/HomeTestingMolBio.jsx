...
const HomeTesting = () => {
  ...
  const handleForTestingPage = () => {
    navigate(`/for-testing-molbio/${userId}`);
  };

  const handleTestResults = () => {
    navigate(`/test-results-molbio/${userId}`);
  };

  const handleDatabase = () => {
    navigate(`/testing-database-molbio/${userId}`);
  };
    ...
    <div className="home-client">
      <main className="main-content">
        ...
        <div className="announcement-box">
          <h4>Welcome to the Molecular Biology Testing Portal!</h4>
        </div>
